  ...
  return (
    <section className="bg-[#1A1F2C] py-16">
      <div className="container">
        <h2 className="mb-4 text-center text-3xl font-bold text-white">Subscribe to our newsletter</h2>
        <p className="mb-8 text-center text-gray-300">Get our latest news and updates</p>
